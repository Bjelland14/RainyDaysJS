...
toolbar.innerHTML = `
  <form id="faq-tools" class="faq-tools" role="search" aria-label="Søk i spørsmål">
    <input id="faq-search" name="q" type="search" placeholder="Søk i spørsmål…" autocomplete="off" />
    <div class="faq-actions">
      <button type="button" id="open-all">Åpne alle</button>
      <button type="button" id="close-all">Lukk alle</button>
    </div>
  </form>
`;
...
const btnOpenAll = document.querySelector("#open-all");
const btnCloseAll = document.querySelector("#close-all");
